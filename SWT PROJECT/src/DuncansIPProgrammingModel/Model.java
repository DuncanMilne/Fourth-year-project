...
public class Model {   
    ...
    ArrayList<ArrayList<Integer>> projectAssignments;
	...
	*/
	public Model(int[][] studentPrefArray, int[][] studentPrefRankArray, int[][] lecturerPrefArray, int[][] lecturerPrefRankArray,
      int[] projUpperQuotas, int[] projLecturers, int[] lecturerUpperQuotas, int numProjects) {
		...
		numLecturers = lecturerPrefArray.length;
